...
if __name__ == "__main__":
    ...
    fields = ["SAC_DS_STMBTSL", "RSAN007"]#, "C_KSWCK", "C_SAC257", "C_SAC240", "C_SAC201", "C_SAC120", "C_FTR059", "C_FTR003"]

    #Scenarios to compare
    alts = ["NAA", "ALT1"]#, "Alt2woTUCPAllVA", "Alt2wTUCPwoVA", "ALT3", "Alt4"]

    report_type = "salinity"

    # Prefix for tables and figures in appendix
    appendix_prefix = " F.2.5"

    # Path to file with location code crosswalk
    location_cw_path = "C:/Users/emadonna/eis-appendix-generation/inputs/location_code_crosswalk_salinity.xlsx"
...
####END OF USER INPUTS #######
    ...
    table_value = "Monthly EC (UMHOS/CM)"

    # Set figure value name
    fig_value = "Monthly EC (UMHOS/CM)"
    ...
    for field_index, location in enumerate(fields):
        ...
        for comparison_index, scenario in enumerate(comparisons):
            ...
            if comp_table_index == (len(comparison_tables) - 1):
                ...
                run = footnote3.add_run('* These results are displayed with calendar year – year type sorting.')
                run.font.size = Pt(9)
